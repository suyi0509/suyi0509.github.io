    ...
    const aboutMeArr = [
        {
            ...
            title: '三、工作经历', context: () => {
                const arr = [
                    {
                        title: '广州市艾美网络科技有限公司', time: '2022.5 - 至今', grade: 'web高级前端工程师',
                    },
                    {
                        title: '广州市棒谷网络科技有限公司', time: '2021.5-2022.5', grade: 'web中级前端工程师',
                    },
                    {
                    ...
                    arr.map((item, index) => {
                        return (
                            <div key={index} className='py-16 border-b border-gray-300'>
                                ...
                                {item.describe && item.describe.map((xitem, xindex) => {
